...
system(paste0("mkdir -p /share/ScratchGeneral/angxue/proj/vQTL/MatrixQTL/PF_test/HVG2000/",ct_name,"/"))
system(paste0("mkdir -p /share/ScratchGeneral/angxue/proj/vQTL/MatrixQTL/PF_test/HVG2000/",ct_name,"/",PF_num,"/"))
setwd(paste0("/share/ScratchGeneral/angxue/proj/vQTL/MatrixQTL/PF_test/HVG2000/",ct_name,"/",PF_num))
...
covariates_file_name = paste0("/share/ScratchGeneral/angxue/proj/vQTL/MatrixQTL/round2_more_covar/covariates/no_outliers_PF50_HVG2000/",new_names[which(new_names==ct_name)],"_covar_peer_factors_PF",PF_num,".txt", collapse='');
