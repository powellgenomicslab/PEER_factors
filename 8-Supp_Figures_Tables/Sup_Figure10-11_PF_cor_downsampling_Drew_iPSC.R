...
pdf(file = "~/Documents/Study/Post-doc/project/vQTL/manuscipt/PF_commentary/Sup_Figure/Sup_Figure10_PF_cor_Drew_iPSC.pdf",width=10,height = 8)
...
# Fibroblast
pdf(file = "~/Documents/Study/Post-doc/project/vQTL/manuscipt/PF_commentary/Sup_Figure/Sup_Figure10_PF_cor_Drew_fibroblast.pdf",width=10,height = 12)
...
ggsave("~/Documents/Study/Post-doc/project/vQTL/manuscipt/PF_commentary/Sup_Figure/Sup_Figure11_downsampling_v2.png",p_cor,width=8,height=8)
