...
# p8a
p8b <- ggplot(old, aes(x = PF, y = eGene)) +
  geom_point(aes(col = ct)) + 
  # geom_vline(aes(xintercept = elbow)) +
  geom_vline(aes(xintercept = local_greedy), linetype = "dashed") +
...
p8 <- ggarrange(p8a, p8b, ncol = 1, nrow = 2, common.legend = F, labels=LETTERS[1:2], align = "v")

ggsave("~/Documents/Study/Post-doc/project/vQTL/manuscipt/PF_commentary/Sup_Figure/Sup_Figure8_local_greedy_PFs.png", p8, width = 13, height = 16, bg = "white")
