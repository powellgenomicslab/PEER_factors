...
ggsave(filename = paste0("~/Documents/Study/Post-doc/project/vQTL/manuscipt/PF_commentary/Figure/Figure1_Panel_",new_names[k],"_v2.png"),plot=pall,width=13,height=12,bg="white")
