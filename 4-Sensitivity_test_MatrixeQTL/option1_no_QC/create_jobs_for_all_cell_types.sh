...
sed 's/PF_num/'${i}'/g;s/ct_name/'${new_names[k]}'/g' run_MatrixQTL.sh > run_MatrixQTL_${new_names[k]}_PF${i}.sh


sh run_MatrixQTL_${new_names[k]}_PF${i}.sh

rm -f run_MatrixQTL_${new_names[k]}_PF${i}.sh
