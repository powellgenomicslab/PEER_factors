...
p11a <- ggplot(old, aes(x = PF, y = eGene)) +
...
ggsave("~/Documents/Study/Post-doc/project/vQTL/manuscipt/PF_commentary/Sup_Figure/Sup_Figure11_PCA_eQTL_sensitivity_test.png", p11, width = 13, height = 16, bg = "white")
